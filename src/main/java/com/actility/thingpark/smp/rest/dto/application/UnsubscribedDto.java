...
/**
 * <p>Java class for UnsubscribedDto complex type.
 *
...
@XmlRootElement(namespace = "http://www.actility.com/smp/ws/application", name = "unsubscribed")
public class UnsubscribedDto {
   ...
   */
  public UnsubscribedDto(final String transactionID, final Subscriber subscriber, final String href) {
  ...
  public UnsubscribedDto withSubscriber(Subscriber value) {
    setSubscriber(value);
    return this;
  }
