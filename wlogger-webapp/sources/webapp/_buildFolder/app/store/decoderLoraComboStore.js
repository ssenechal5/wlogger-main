Ext.define('WirelessLogger.store.decoderLoraComboStore', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            storeId: 'decoderLoraComboStore',
            proxy: {
                type: 'ajax',
//                url: '/thingpark/wlogger/rest/stores/decoder?type=0',
                url: '/thingpark/wlogger/rest/stores/decoder?domain='+operatorDomain+"&type="+type+"&locale="+lang+"&decType=0",
                reader: {
                    type: 'json'
                }
            }
