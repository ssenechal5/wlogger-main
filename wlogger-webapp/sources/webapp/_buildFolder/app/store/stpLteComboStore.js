Ext.define('WirelessLogger.store.stpLteComboStore', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            storeId: 'stpLteComboStore',
            proxy: {
                type: 'ajax',
                url: '/thingpark/wlogger/rest/stores/subtype?domain='+operatorDomain+"&type="+type+"&locale="+lang+"&subtype=1&np=0",
                reader: {
                    type: 'json'
                }
            }
