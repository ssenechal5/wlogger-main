Ext.define('WirelessLogger.store.stpComboStore', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            storeId: 'stpComboStore',
            proxy: {
                type: 'ajax',
                url: '/thingpark/wlogger/rest/stores/subtype?domain='+operatorDomain+"&type="+type+"&locale="+lang+"&subtype=0&np="+((com.actility.global.notNetworkPartnerAccess)?"0":"1"),
                reader: {
                    type: 'json'
                }
            }
